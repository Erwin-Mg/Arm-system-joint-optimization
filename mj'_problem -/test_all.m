...
[robot_type,robotArm,joint_number,length_robot] = buildrobot_EDN(X(1:6));
%% 函数值计算
...
if robot_type
    ...
    robot_4 = buildrobot_EDN(X(1:6));
    [R_BA1,Jacob,endlocation,g]=endlocation_III(robot,joint_number,N);
    Popobj_initial = obj_multiarm(X(7:end),length_robot,joint_number,robotArm,R_BA1,Jacob,endlocation,N);  % 计算适应度函数值
    ...
    Popobj_initial  = 50000*ones(1,4);
    Popobj_nullspace = 50000*ones(1,6);
end
